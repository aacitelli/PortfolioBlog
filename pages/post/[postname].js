    ...
    <>
      ...
      <Layout pageTitle={`Blog | ${frontmatter.title}`} description={`Hey! I'm Anden, a Software Developer looking to contribute my knowledge on all sorts of things back into the community. See more articles like '${frontmatter.title}' at my blog!`} >
        ...
        <article>
          ...
          <p>I try to write concise articles that aren't a waste of time - please consider <Link href="https://paypal.me/andenacitelli"><a>tipping me via Paypal</a></Link> or turning off your adblocker if you got a lot of value from the article. Thanks for reading!</p>
        </article>
      </Layout>
      <style jsx>{`
        article {
